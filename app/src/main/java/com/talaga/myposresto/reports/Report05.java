...
public class Report05 extends AppCompatActivity {
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sql="select stk.category,cat.description, sum(il.amount) as zamt " +
                ...
                "left join ksr_category cat on cat.category=stk.category " +
                "group by stk.category,cat.category";
