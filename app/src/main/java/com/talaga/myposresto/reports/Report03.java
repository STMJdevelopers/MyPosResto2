...
public class Report03 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sql="select i.customer,c.company, sum(i.amount) as zamt " +
                "from ksr_sales_header i left join ksr_customers c " +
                "on c.customer_no=i.customer " +
                "group by i.customer";
    ...
    void setColumnHeader(){
        ...
        judul.setText("SalesActivity by Customer");

        TextView txt1= (TextView) findViewById(R.id.txt1);
        txt1.setText("Cust No");
        txt1.setWidth(100);

        TextView txt2= (TextView) findViewById(R.id.txt2);
        txt2.setText("Cust Name");
        txt2.setWidth(200);
